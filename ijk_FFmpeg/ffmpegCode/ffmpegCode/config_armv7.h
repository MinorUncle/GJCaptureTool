...
#ifndef FFMPEG_CONFIG_ARMV7_H
#define FFMPEG_CONFIG_ARMV7_H
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --enable-nonfree --enable-version3 --disable-bzlib --enable-small --disable-vda --disable-encoders --enable-libx264 --enable-encoder=libx264 --disable-muxers --enable-muxer=flv --enable-muxer=mov --enable-muxer=mpegts --enable-muxer=psp --enable-muxer=mp4 --enable-muxer=avi --disable-decoders --enable-decoder=h264 --enable-decoder=mpeg4 --disable-demuxers --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=avi --enable-demuxer=mpegts --enable-demuxer=mpc --enable-demuxer=mov --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --disable-protocols --enable-protocol=file --enable-protocol=rtmp --enable-protocol=rtp --enable-protocol=udp --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --disable-devices --disable-ffmpeg --disable-ffprobe --disable-ffplay --disable-ffserver --extra-cflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode -I/Users/tongguan/Desktop/ffmpeg-iphone-build-master/fat-x264/include' --extra-ldflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode -L/Users/tongguan/Desktop/ffmpeg-iphone-build-master/fat-x264/lib' --prefix=/Users/tongguan/Desktop/ffmpeg-iphone-build-master/thin/armv7"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/tongguan/Desktop/ffmpeg-iphone-build-master/thin/armv7/share/ffmpeg"
#define AVCONV_DATADIR "/Users/tongguan/Desktop/ffmpeg-iphone-build-master/thin/armv7/share/ffmpeg"
