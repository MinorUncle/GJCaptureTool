...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.textView.text = //@"rtmp://10.0.20.150/live/room";
    @"http://pull-test.kktv8.com/livekktv/73257119.flv";
    //@"http://pull.kktv8.com/livekktv/117367989.flv";
    //@"rtmp://10.0.20.150/live/room";
