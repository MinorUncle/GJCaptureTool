...
#define GFloatEqual(A, B) ({GFloat d = (GFloat)A - (GFloat)B;d > -0.000001 && d < 0.000001; })
#define GDoubleEqual(A, B) ({GDouble d = (GDouble)A - (GDouble)B;d > -0.000000000000001 && d < 0.000000000000001; })
