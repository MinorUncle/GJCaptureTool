...
typedef void(*PullMessageCallback)(GJRTMPPullMessageType messageType,void* rtmpPullParm,void* messageParm);
typedef void(*PullDataCallback)(GJRTMPDataType dataType,GJRetainBuffer* buffer,uint32_t dts);
