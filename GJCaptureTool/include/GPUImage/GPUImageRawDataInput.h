...
- (id)initWithPixelFormat:(GPUPixelFormat)pixelFormat type:(GPUPixelType)pixelType;
- (id)initWithBytes:(CVImageBufferRef )imageBuffer;
...
// Image rendering
- (void)updateDataFromImageBuffer:(CVImageBufferRef )imageBuffer;
